...
feature_annotations = read_tsv(args[4]) # internal_output/counts/genome/bgtables/internal/fake_oligoCLIP_from_eCLIP.IGF2BP2.tsv.gz 
...
print(paste0(output_stem, '.enriched_window_coverage.pdf'))
pdf(file.path(enriched_window_fig_folder, paste0(output_stem, '.enriched_window_coverage.pdf')), height = 2, width = 2.8)
