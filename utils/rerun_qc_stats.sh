...
--configfile config/preprocess_config/oligope_iter6.yaml --use-conda --conda-prefix /home/hsher/snakeconda QC/summary.csv -n
...
--configfile config/preprocess_config/oligose_k562_noalt.yaml --use-conda --conda-prefix /home/hsher/snakeconda QC/summary.csv -n